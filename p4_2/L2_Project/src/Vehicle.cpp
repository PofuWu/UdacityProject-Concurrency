    ...
    while (true)
    {
        ...
        if (timeSinceLastUpdate >= cycleDuration)
        {
            ...
            if (completion >= 0.9 && !hasEnteredIntersection)
            {
                ...
                //get_shared_this() : see vehicle.h, to get the object class of shared ptr, cannot use "this" directly.
                auto entryGranted = std::async(&Intersection::addVehicleToQueue, _currDestination, get_shared_this());
