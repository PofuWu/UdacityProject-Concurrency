...
public:
    ...
    Vehicle popBack()
    {
        ...
        // Also, we are still holding the lock and thus no other thread is able to access the 
        // vector - so there is no danger of a data race in this situation. As soon as we are 
        // out of scope8, the lock will be automatically released.
